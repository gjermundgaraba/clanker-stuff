...
1. Resolve a reusable, read-only checkout of `earendil-works/pi` at `~/.cache/checkouts/github.com/earendil-works/pi`, checked out at `v0.85.0`. Partial-clone it if absent. Never edit the shared checkout.
