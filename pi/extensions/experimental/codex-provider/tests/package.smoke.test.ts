  ...
  it("packs, installs, and loads with production peer resolution", async () => {
    ...
    expect(entries).toStrictEqual(
      [
        ...
        "package/code-mode/output-display.ts",
        "package/code-mode/renderers.ts",
        ...
        "package/docs/upstream-review.md",
        "package/footer.ts",
        "package/index.ts",
        ...
        "package/tools/process-metadata.ts",
