...
```bash
vp test --project unit pi/extensions/experimental/footer
vp test --project integration pi/extensions/experimental/footer
vp test --project smoke pi/extensions/experimental/footer
vp check pi/extensions/experimental/footer
vp run ready
```
