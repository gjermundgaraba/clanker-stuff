...
The [2026-09-13 upstream review](../../codex-provider/docs/upstream-review.md) records relevant deltas through [`36f0dbe796d9bb1a18a0fc0640ed08b3e1d54564`](https://github.com/openai/codex/tree/36f0dbe796d9bb1a18a0fc0640ed08b3e1d54564). Selected tool/catalog facts remain unchanged and the generated fixture now uses that revision. The historical prose below retains its original baseline; consult the review for newer role-instruction regeneration, forked configuration/authorization context, and bounded V2 child-environment inventory.
