...
The [2026-09-13 upstream review](../../codex-provider/docs/upstream-review.md) records relevant deltas through [`36f0dbe796d9bb1a18a0fc0640ed08b3e1d54564`](https://github.com/openai/codex/tree/36f0dbe796d9bb1a18a0fc0640ed08b3e1d54564). Selected tool facts remain pinned there. The fixture's catalog declarations are separately updated to `rust-v0.156.1` (`b412ff32c417f855c2b2d1581b77058eed87c84b`), adding GPT-6 Sol/Luna as V2 without repinning this historical prose. The historical prose below retains its original baseline; consult the review for newer role-instruction regeneration, forked configuration/authorization context, and bounded V2 child-environment inventory.
...
**Selected delta, 2026-09-13 (`36f0db...`):** The V2 portion of the historical description above is superseded. V2 enumerates all registered direct children, including unloaded ones, renders `<agent name="/root/worker" />` with canonical paths and no nicknames, and prioritizes resident children while preserving alphabetical order within both groups. The `<subagents>` block is limited to eight children and 1,024 bytes including indentation and wrapper; paths that exceed the remaining byte budget are skipped. Non-V2 enumeration and nickname formatting remain unchanged. See [current control formatting](https://github.com/openai/codex/blob/36f0dbe796d9bb1a18a0fc0640ed08b3e1d54564/codex-rs/core/src/agent/control.rs) and the [Pi projection](protocols.md#v2-child-inventory).
