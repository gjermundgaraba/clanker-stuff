...
- [`agent/control.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/agent/control.rs)
- [`agent/registry.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/agent/registry.rs)
- [`thread_manager.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/thread_manager.rs)

## 2. Child-session construction

Fresh children clone the parent's effective live configuration, then apply protocol-, role-, model-, and effort-specific changes. Role overrides are a typed, bounded projection: they can specialize model behavior or reduce capabilities but cannot replace the provider, endpoints, permissions, or other parent authority. The root-owned default service-tier sentinel is applied unconditionally; a non-default tier is applied only when the final child model supports it. Codex preserves the parent's cwd, approval policy, sandbox, permission profile, shell policy, and managed command policy rather than rebuilding those values from disk. The child receives a distinct thread ID and session source carrying its parent identity, path, nickname, role, and depth.
...
- [`multi_agents_common.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/tools/handlers/multi_agents_common.rs)
- [`agent/role.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/agent/role.rs)
- [`service_tier.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/agent/control/service_tier.rs)
- [`protocol.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/protocol/src/protocol.rs)
...
- [`agent/control/legacy.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/agent/control/legacy.rs)
- [`multi_agents/resume_agent.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/tools/handlers/multi_agents/resume_agent.rs)
- [`agent/control/spawn.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/agent/control/spawn.rs)
...
On resume, Codex restores V2 identity metadata without eagerly loading every rollout. A later message or task can load the target lazily. Explicit app-server child resume first loads and validates the recorded immediate parent, then rebuilds the child's authority from that parent while restoring the child's stored model-provider ID, model, reasoning, and role settings. The provider ID must resolve in the resumed provider map. Consequently, addressability, residency, and `list_agents` visibility are related but not identical concepts.

Primary sources:

- [`agent/control/execution.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/agent/control/execution.rs)
- [`agent/control/residency.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/agent/control/residency.rs)
- [`agent/control/spawn.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/agent/control/spawn.rs)
- [`multi_agent_resume.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/tests/suite/multi_agent_resume.rs)
...
Full-history forks preserve the latest durable world-state reference baseline, including across nested agent forks. Developer messages are sanitized at annotated content-item granularity so inherited collaboration mode and role hints are removed without discarding unrelated developer context. Partial forks rebuild reference context.

Primary sources:

- [`protocol.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/protocol/src/protocol.rs)
- [`state/src/extract.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/state/src/extract.rs)
- [`rollout_reconstruction.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/session/rollout_reconstruction.rs)
- [`0021_thread_spawn_edges.sql`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/state/migrations/0021_thread_spawn_edges.sql)
...
- [`event_mapping.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/app-server-protocol/src/protocol/event_mapping.rs)
- [`turn_processor.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/app-server/src/request_processors/turn_processor.rs)
- [`agent_navigation.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/tui/src/app/agent_navigation.rs)
...
- [`hook_runtime.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/hook_runtime.rs)
- [`rollout_budget.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/rollout_budget.rs)
- [`responses_metadata.rs`](https://github.com/openai/codex/blob/389dd5645944891b65e4ca584125bbb0c852d352/codex-rs/core/src/responses_metadata.rs)
