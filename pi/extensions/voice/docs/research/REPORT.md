...
`pi/extensions/voice/docs/research/codex-runtime-recorder.mjs` launched the installed signed app with:
...
`pi/extensions/voice/docs/research/pi-runtime-recorder.ts` ran as an explicit Pi extension. The voice extension's `PI_VOICE_TRACE_DIR` hook recorded:
...
Codex constructs this in `codex-rs/core/src/context/realtime_delegation.rs`. Pi constructs the same shape in `pi/extensions/voice/transcript.ts`.
...
- `pi/extensions/voice/docs/research/codex-runtime-recorder.mjs`
- `pi/extensions/voice/docs/research/codex-cli-proxy.mjs`
- `pi/extensions/voice/docs/research/extract-codex-capture.mjs`
- `pi/extensions/voice/docs/research/pi-runtime-recorder.ts`
- `pi/extensions/voice/docs/research/extract-pi-capture.mjs`
- `pi/extensions/voice/trace.ts`
