...
describe("reverse search", () => {
  it("searches newest-first and accepts without submitting", () => {
    ...
    expect(ctx.ui.getEditorText()).toBe("Check deploy status");
    expect(host.getWidget("reverse-i-search")).toBeUndefined();
  ...
  it("keeps no-match search open and restores the original draft", () => {
    ...
    expect(host.getWidget("reverse-i-search")).toContain("no match");
    ...
    expect(host.getWidget("reverse-i-search")).toBe("reverse-i-search: ");
