...
pnpm exec vitest run --project integration codex-provider/tests
pnpm exec ultracite check codex-provider/checkpoint.ts codex-provider/replay.ts codex-provider/remote.ts codex-provider/lifecycle.ts codex-provider/spike.ts codex-provider/tests
pnpm exec oxfmt --check codex-provider/checkpoint.ts codex-provider/replay.ts codex-provider/remote.ts codex-provider/lifecycle.ts codex-provider/spike.ts codex-provider/tests codex-provider/phase-two-results.md
pnpm typecheck
pnpm check:tests
```
