...
This request-local proof handles trailing, interior, and repeated retry failures without persisting retry state or changing checkpoint schema v4. Marker-free structural parity still validates the complete finalized Responses input before provider execution.
